...
const portfolioData = {
  ...
  // Las demás secciones siguen en la siguiente parte...
};
...
@keyframes shine-glow {
  ...
  50% {
    text-shadow: 0 0 20px #10b981, 0 0 30px #10b981, 0 0 40px #10b981, 0 0 50px #ffa500;
  }
}
.title-shine {
  color: #10b981;
...
// Sección individual reutilizable
...
// Tarjeta colapsable (experiencia y proyectos)
